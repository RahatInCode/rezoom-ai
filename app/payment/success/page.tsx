...
import { CheckCircle, Sparkles, ArrowRight, Download } from "lucide-react";
...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f0fdf4] to-white flex items-center justify-center px-6 py-12">
      <div className="max-w-2xl w-full">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <div className="bg-[#f0fdf4] rounded-xl p-6 mb-8 text-left">
            <div className="flex items-start gap-3 mb-4">
              <Sparkles className="w-5 h-5 text-[#10b981] mt-1 flex-shrink-0" />
            ...
            <div className="flex items-start gap-3">
              <Download className="w-5 h-5 text-[#10b981] mt-1 flex-shrink-0" />
              <div className="flex-1">
                <p className="text-sm text-[#64748b]">Session ID</p>
                <p className="text-xs text-[#10b981] font-mono break-all">
                  {sessionId}
                </p>
              </div>
            </div>
        ...
        <p className="text-center text-[#64748b] mt-8">
          Questions?{" "}
          <a
            href="mailto:support@rezoom-ai.com"
