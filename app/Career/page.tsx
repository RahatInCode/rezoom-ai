      ...
      <section className="mt-20">
        ...
        <div className="w-full pt-24 gap-4 flex">
          ...
          <div className="w-full lg:w-3/4 text-sm lg:text-[19px] p-5 overflow-auto scroll-smooth">
            <p className="mb-12">
              Welcome to the Resume Builder Career Center, your one-stop shop
              for resume and cover letter writing, interview tips, and job
              search resources...
            </p>

            {/* Featured Advice */}
            <div id="featured" className="w-full space-y-10">
              <h1 className="text-[#A053CF] text-5xl font-semibold">
                Featured Advice
              </h1>
              <p>
