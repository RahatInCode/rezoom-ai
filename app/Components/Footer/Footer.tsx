...
function Footer2() {
  ...
  const socialIcons = [
    ...
    },
    {
      ...
      svg: (
        <svg
          className="size-6 transition-transform duration-200 hover:scale-110"
          xmlns="http://www.w3.org/2000/svgj"
          width="1em"
          height="1em"
          viewBox="0 0 24 24"
        >
  ...
  return (
    <footer className="py-10 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden border-2 rounded-xl bg-white ">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        <div className="mb-6 flex items-center justify-center">
          ...
          <span className="text-gray-900 dark:text-whit text-3xl font-extrabold tracking-wide">
           Rezoom.AI
          </span>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-4">
          &copy; {new Date().getFullYear()} All rights reserved by Rezoom.Ai
        </p>
      </div>
    </footer>
  );
