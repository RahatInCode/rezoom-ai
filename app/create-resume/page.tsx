...
//     <div className="modal-box bg-gray-100 backdrop-blur-md border border-gray-200 shadow-lg">
//       <form method="dialog">
...
//         <div className='w-full text-sm font-semibold p-2 bg-white/80 backdrop-blur-sm rounded-lg flex justify-between items-center'>
//           <p>Save as PDF</p>
...
//     {/* Left Panel - Form */}
//     <div className='w-full p-5 min-h-96 bg-white rounded-md border border-gray-300'>
...
//           {currentStep < 3 && <button onClick={()=>setCurrentStep(currentStep+1)} className='btn btn-primary px-12 btn-sm lg:btn-md'>Next <MoveRight size={16} strokeWidth={0.75} /></button>}
//           {currentStep === 3 && <button onClick={()=> handleModalOpen()} className='btn px-12 btn-sm btn-primary lg:btn-md'>Save</button>}
//         </div>
//       </div>
//     </div>

//     {/* Right Panel - Live Preview */}
//     <div id='ResumePreview' className='w-full min-h-96 whitespace-normal break-words rounded-md border border-gray-300 bg-white p-5'>
...
//       <div className='w-full text-center flex flex-wrap justify-center gap-5 text-sm font-thin'>
//         <p>{resumeData.PersonalInfo.Email}</p>
//         <p>{resumeData.PersonalInfo.PhoneNumber}</p>
//         <p>{resumeData.PersonalInfo.Location}</p>
//       </div>

//       <div className='w-full flex justify-center flex-wrap gap-3 text-sm text-blue-500 font-thin'>
